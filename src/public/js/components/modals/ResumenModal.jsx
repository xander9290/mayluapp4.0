      ...
      <Modal.Body>
        <div id="body">
          ...
          <div
            id="resumenServicios"
            style={{
              display: settings.resumenVenta.resumenServicios
                ? "block"
                : "none",
            }}
          >
            ...
            <h2
              id="ventaTotal"
              style={{
                display: settings.resumenVenta.ventaTotal ? "block" : "none",
              }}
            >
              venta total: $
              {servicios.comedor.total +
          ...
          <div
            id="movientosCaja"
            style={{
              display: settings.resumenVenta.movientosCaja ? "block" : "none",
            }}
          >
            <div
              style={{
          ...
          <div
            id="pagosTarjeta"
            style={{
              display: settings.resumenVenta.pagosTarjeta ? "block" : "none",
            }}
          >
            <div
              style={{
          ...
          <div
            id="otrosMedios"
            style={{
              display: settings.resumenVenta.otrosMedios ? "block" : "none",
            }}
          >
            <div
              style={{
          ...
          <h2
            id="totalEfectivo"
            style={{
              display: settings.resumenVenta.totalEfectivo ? "block" : "none",
            }}
          >
            efectivo: $
            {servicios.comedor.total +
          ...
          <div
            id="descuentoCuentas"
            style={{
              display: settings.resumenVenta.descuentoCuentas
                ? "block"
                : "none",
            }}
          >
          ...
          <div
            id="canceladoCuenta"
            style={{
              display: settings.resumenVenta.canceladoCuenta ? "block" : "none",
            }}
          >
          ...
          <div
            id="canceladoProductos"
            style={{
              display: settings.resumenVenta.canceladoProductos
                ? "block"
                : "none",
            }}
          >
